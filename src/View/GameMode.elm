module View.GameMode exposing (GameModeDetails, viewGameMode)
...
viewGameMode gameMode =
    Theme.column
        ...
        [ Theme.blocks [] """
            ...
            """
        , [ gameModeBox gameMode storyArc
          , gameModeBox gameMode earlyBird
          , gameModeBox gameMode skillTree
          , gameModeBox gameMode constellation
          , Theme.blocks
...
type alias GameModeDetails =
    { name : GameMode
    , content : String
    }


storyArc : GameModeDetails
storyArc =
    { name = StoryArc
    , content =
        """
